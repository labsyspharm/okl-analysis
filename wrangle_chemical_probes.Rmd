...
synLogin()
syn <- synDownloader(normalizePath("~/data"), ifcollision = "overwrite.local")
```
...
c(
  ...
  synStoreMany(parent = syn_probes, activity = activity, forceVersion = FALSE)
